<template>
  <div>
    <div class="flex mt-3">
      ...
      <nuxt-link to="/login">
        <div class="ml-2 text-black">Назад</div>
      </nuxt-link>
    </div>
    <h1 class="font-bold text-4xl mt-3">Как это работает?</h1>
    <ul>
      <li class="list-item">
        <img src="~/assets/icons/gps.png" class="list-icon" alt="" />
        По GPS мы находим, где вы находитесь
      </li>
      <li class="list-item">
        <img src="~/assets/icons/clock.png" class="list-icon" alt="" />
        По рейсу определяем, когда пора идти
      </li>
      <li class="list-item">
        <img src="~/assets/icons/coffee.png" class="list-icon" alt="" />
        Показываем ближайшие кафе и магазины
      </li>
      <li class="list-item">
        <img src="~/assets/icons/places.png" class="list-icon" alt="" />
        Места, где можно зарядить телефон или обратиться за помощью
      </li>
    </ul>
    <div class="h-40 m-auto">
      <img src="~/assets/ticket.png" class="p-5 mt-5" alt="" />
    </div>
  </div>
</template>
