...
export default {
  ...
  data() {
    return {
      ...
      popupData: {
        currentText: 'До открытия регистрации 46 минут',
        currentStep: 2,
        popupTexts: [
          {
            title: 'Регистрация через 46 минут',
          },
          {
            title: 'Посадка открывается в 23:47',
            subtitle: 'Остался 1 час 40 минут',
          },
          {
            title: 'Посадка закрывается в 00:07',
            subtitle: 'Через 2 часа 8 минут',
          },
          {
            title: 'Самолёт взлетает в 00:28',
            subtitle: 'Через 2 часа 29 минут',
          },
          {
            title: 'Самолёт прилетает в 01:28',
            subtitle: 'Через 3 часа 29 минут',
          },
        ],
      },
    }
